...
DROP TABLE IF EXISTS food_delivery.reviews CASCADE;
DROP TABLE IF EXISTS food_delivery.deliveries CASCADE;
DROP TABLE IF EXISTS food_delivery.order_items CASCADE;
DROP TABLE IF EXISTS food_delivery.orders CASCADE;
DROP TABLE IF EXISTS food_delivery.menu_items CASCADE;
DROP TABLE IF EXISTS food_delivery.drivers CASCADE;
DROP TABLE IF EXISTS food_delivery.restaurants CASCADE;
DROP TABLE IF EXISTS food_delivery.customers CASCADE;
